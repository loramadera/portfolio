        ...
        <div className='product-demo-nav-foreground'>
          <div className="flexbox">  
            ...
            <div className='right-align top-small'>   
              <a href="/product-demo-home" className='product-nav padding-small'>Home</a>
              <a href="/product-demo" className='product-nav padding-small'>Creation</a>
              <a href="/product-demo-cart" className='product-nav padding-small'>Cart</a>
            </div>
          </div>
        </div> 
      </div>
