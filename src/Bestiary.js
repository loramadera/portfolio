...
function Bestiary() {
			...
			<div className='flexbox'>
				...
				<div className='flex2 box'>
					<div className='small-border margins-small'>
						<h3 className='h3-primary'>{item.title}</h3>
					</div>
  ...
  function Mvp() {
    if (window.innerWidth < 1025) {
      ...
      return mvpItems.map((item, index) => {
        if (index % 2) {
          return <div className='margins-small top-small'>	
			...
			<div className='margins-large'>
					...
					<div className='flexbox margins-small'>
							<div className='flex1 mobile'>	
								<div className='flexbox mobile-center'>
									...
									<div className='flex2 box'>
										<h3 className='h3-primary sword-title'>Questions for Audience</h3>
									</div>						
								</div>		
						...
						<div className='flex1'>
							...
							<div className='flex1 mobile'>	
								<div className='flexbox mobile-center'>
									...
									<div className='flex2 box'>
										<h3 className='h3-primary sword-title'>Questions for Expert</h3>
									</div>						
								</div>	
							</div>
				...
				<div className='bottom-border top-small mobile'>
					...
					<div className='flexbox margins-small top-medium mobile-center'>
							...
							<div className='flex2 box'>
								<h3 className='h3-primary sword-title'>Key Feedback from Expert</h3>
							</div>						
					</div>
						<div className='flexbox top-medium margins-small'>
								...
								<div className='flex1 box mobile'>
									<h3 className='h3-primary'>Key Feedback</h3>
				...
				<div className='bottom-border top-medium mobile'>
					...
					<div className='margins-small'>
						<h3 className='h3-primary top-small bottom-small'>The bestiary can be broken down into three diagram pieces - the game itself, generated by the game engine, the interface content, and the content generated by the user.</h3>
					</div>
					<div className='flexbox margins-small bottom-medium mobile'>
						<div className='flex1 center-align margins-tiny'>
							<h3 className='h3-primary'>Data Content</h3>
								<div className='best-box'>	
									<div>
										<div>
											<h3 className='h3-primary'>Mythology Content</h3>
											<p className='p-primary'>Pre-generated data set</p>
										</div>
										<div>
											<h3 className='h3-primary'>Game Environment</h3>
						...
						<div className='flex1 center-align margins-tiny'>
							<h3 className='h3-primary'>Generated Content</h3>
								<div className='best-box'>	
									<div>
										<div>
											<h3 className='h3-primary'>Cryptid Biography</h3>
											<p className='p-primary'>Pre-set inputs for insight fields</p>
										</div>
										<div>
											<h3 className='h3-primary'>Inventory</h3>
						...
						<div className='flex1 center-align margins-tiny'>
							<h3 className='h3-primary'>User Content</h3>
								<div className='best-box'>	
									<div>
										<div>
											<h3 className='h3-primary'>Journal Entries</h3>
											<p className='p-primary'>Inputed by user</p>
										</div>
										<div>
											<h3 className='h3-primary'>Account Info</h3>
				...
				<div className='bottom-border top-small'>
					...
					<div className='margins-small top-small mobile'>
						<h3 className='h3-primary task-flex'>User Flow One: Document Your Battle</h3>
					...
					<div className='margins-small'>	
								<div className='flexbox top-small center-align'>
									<div className='flex1 box'>
										<div className='flexbox'>
											<div className='flex1 box center-align'>
												<h3 className='h3-primary flex-number'>1</h3>
											</div>
											<div className='flex1 box margins-small'>
												<h3 className='h3-primary flex-text'>Open journal.</h3>
											</div>
										</div>
									</div>
									<div className='flex1 box'>
										<div className='flexbox'>
											<div className='flex1 box'>
												<h3 className='h3-primary flex-number'>2</h3>
											</div>
											<div className='flex1 box margins-small'>
												<h3 className='h3-primary flex-text'>Inspect the monster you faced in the journal.</h3>
											</div>
										</div>
									</div>
									<div className='flex1 box'>
										<div className='flexbox'>
											<div className='flex1 box'>
												<h3 className='h3-primary flex-number'>3</h3>
											</div>
											<div className='flex1 box margins-small'>
												<h3 className='h3-primary flex-text'>Unlock new available entry based on level passed.</h3>
											</div>
										</div>
									</div>
									...
									<div className='flex1 box'>
										<div className='flexbox'>
											<div className='flex1 box'>
												<h3 className='h3-primary flex-number'>4</h3>
											</div>
											<div className='flex1 box margins-small'>
												<h3 className='h3-primary flex-text'>Document the battle, noting hints and info.</h3>
											</div>
										</div>
									</div>
									...
									<div className='flex1 box'>
										<div className='flexbox'>
											<div className='flex1 box'>
												<h3 className='h3-primary flex-number'>5</h3>
											</div>
											<div className='flex1 box margins-small'>
												<h3 className='h3-primary flex-text'>Save entry for later reference.</h3>
											</div>
										</div>
									</div>
								</div>
								...
								<div className='flexbox top-small'>
									...
									<div className='flex1 box'>
										<div className='flexbox'>
											...
											<div className='flex1 box margins-small'>
												<h3 className='h3-primary flex-text'>Find monster’s attributes and weakness boxes.</h3>
											</div>
										</div>
									</div>
									...
									<div className='flex1 box'>
										<div className='flexbox'>
											...
											<div className='flex1 box margins-small'>
												<h3 className='h3-primary flex-text'>Select attribute or weakness box to unlock.</h3>
											</div>
										</div>
									</div>
									...
									<div className='flex1 box'>
										<div className='flexbox'>
											...
											<div className='flex1 box margins-small'>
												<h3 className='h3-primary flex-text'>Unlock weakness or attribute.</h3>
											</div>
										</div>
									</div>
								</div>			
								...
								<div className='flexbox top-small'>
									...
									<div className='flex1 box'>
										<div className='flexbox'>
											...
											<div className='flex1 box margins-small'>
												<h3 className='h3-primary flex-text'>Find monster’s “weakness” panel to unlock.</h3>
											</div>
										</div>
									</div>
									...
									<div className='flex1 box'>
										<div className='flexbox'>
											...
											<div className='flex1 box margins-small'>
												<h3 className='h3-primary flex-text'>Navigate to inventory page in bestiary.</h3>
											</div>
										</div>
									</div>
									...
									<div className='flex1 box'>
										<div className='flexbox'>
											...
											<div className='flex1 box margins-small'>
												<h3 className='h3-primary flex-text'>Scroll through ingredients to find weakness.</h3>
											</div>
										</div>
									</div>
								</div>			
