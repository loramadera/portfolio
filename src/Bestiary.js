		...
		<div className='mobile'>
			...
			<div className='bottom-border top-medium mobile'>
				...
				<div className='flexbox margins-medium mobile-center mobile'>
						...
						<div className='flex2 box'>
							<h4 className='h4-primary sword-title'>Identifying The MVP</h4>
						</div>						
				</div>
				<div className='flexbox margins-medium'>
					<div className='margins-small'>
						<div className='flex1 features mobile-center'>
				...
				<div className='margins-small'>
					<h4 className='h4-primary margins-medium top-small bottom-small'>The bestiary can be broken down into three diagram pieces - the game itself, generated by the game engine, the interface content, and the content generated by the user.</h4>
				</div>
			...
			<div className='bottom-border top-small'>
				...
				<div className='flexbox margins-medium mobile-center mobile'>
						...
						<div className='flex2 box'>
							<h4 className='h4-primary sword-title'>User Flows</h4>
						</div>						
				</div>
				<div className='margins-extra'>
					<h4 className='h4-primary task-flex'>User Flow One: Document Your Battle</h4>
					<p className='p-primary task-flex'>User will document the battle they just encountered and the monster they defeated. They will navigate to the journal entry in the bestiary and create a new entry documenting everything they learned.</p>
				</div>	
