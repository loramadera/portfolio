...
function Bio() {
  const contentItems = [
    { 'title': 'About Me', 'text': 'After graduating with a degree in economics from UC San Diego, I stumbled into UX/UI design and fell in love (my favorite story to tell). I love working on projects that are innovative and intellectually stimulating, even more so if they make the world better. UX/UI intersects my fascination (both personal and professional) with people and psychology, with an artistic bent - I am lucky to be doing what I love!', 'image': imgMe },
