...
function Bio() {
  const contentItems = [
    { 'title': 'About Me', 'text': 'I stumbled into UX/UI design at my first post-undergraduate job and never looked back. I love working on projects that are innovative and intellectually stimulating, even more so if they make the world better. UX/UI intersects my fascination (both personal and professional) with people and psychology, with an artistic bent - I am lucky to be doing what I love!', 'image': imgMe },
    // { 'title': 'Hobbies and Interests', 'text': 'I love skiing and pride myself on my ability to teach anyone to ski in a day (bunnies to blues). Disc golf, tennis, fitness training and hiking are also some favorite pastimes. I also love books and writing and am a published fantasy author!', 'image': imgSki },
